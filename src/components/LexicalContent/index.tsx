...
const getNodeClassNames = (node: SerializedLexicalNode) => {
  ...
  let classNames = ''
  if (String(node?.style).includes('font-family: Absolut Headline;'))
    classNames += 'font-absolut-headline '
  if (String(node?.style).includes('font-family: Absolut Handwritten;'))
    classNames += 'font-absolut-handwritten '
